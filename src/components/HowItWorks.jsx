 ...
 const HowItWorks = () => {
   return (
    //visual show four step process with either icons or image sliders
     <motion.div className='my-10 flex flex-col items-center h-[90vh] lg:h-[60vh]' variants={hiwVariants} initial="initial" whileInView="animate" viewport={{once: true, amount: 0.2}}>
        ...
        <div className='my-auto grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4 w-9/12'>
          <motion.div variants={boxVariants} className='relative rounded-lg shadow-lg border flex flex-col items-center py-6'>
            <div className='absolute bg-black w-12 h-12 text-white p-3 text-xl font-bold rounded-full -top-5 -left-5'>
              <p>01</p>
            </div>
