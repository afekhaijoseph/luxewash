...
const About = () => {
  ...
  return (
    <motion.section id="about" className='my-14 w-10/12 lg:w-3/5 mx-auto' variants={aboutVariant} initial="initial" whileInView="animate" viewport={{ once: true, amount: 0.2}}>
      ...
      <div className="area-aboutone rounded-lg">
        <img className="w-full h-full object-cover rounded-lg" src={aboutone} alt="Laundry attendant sitting with folder laundry" />
      </div>
      ...
      <div className="area-aboutthree h-full w-full rounded-lg">
        <img className="w-full h-full object-cover rounded-lg" src={aboutthree} alt="Laundry staff ironing customer fabric" />
      </div>
    </div>

        <div className='basis-full'>
          <p className='text-center md:text-left text-lg leading-relaxed'>At LuxeWash, luxury isn't just a label — it's the standard we live by. We provide premium laundry services in Victoria Island,
             lekki, Ikoyi, Eko atlantic city, with fabric-friendly laundrycare with unmatched attention to detail, ensuring every garment is handled with elegance and precision. From delicate
