...
const Hero = () => {
  ...
  return (
    <>
      <div className='absolute top-1/4 md:top-1/3 left-1/2 -translate-x-1/2 w-11/12 lg:w-8/12 mx-auto flex flex-col gap-10 text-gray-300'>
            ...
            <button className='border border-gray-300 w-fit self-center p-3 rounded-md hover:bg-[#002147] hover:border-[#002147] hover:text-white'>Schedule a Pick up</button>
        </div>
