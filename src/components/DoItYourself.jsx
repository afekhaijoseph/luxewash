...
const DoItYourself = () => {
  ...
  return (
    <motion.div className='my-10' variants={diyVariant} initial="initial" whileInView="animate" viewport ={{once: true, amount: 0.2}}>
        ...
        <div style={{ backgroundImage:`url(${bgImages[currentImage]})` }} className='relative text-white bg-cover bg-center h-[50vh] w-9/12 mx-auto my-6 lg:h-[90vh] rounded-xl'>
        <div className='absolute inset-0 bg-black opacity-30 rounded-xl'></div>
        <div className='absolute z-10 top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 text-center w-full'>
            <p className='text-3xl p-3 md:text-4xl font-playfair'>Enjoy our self-service machines in a chill environment. Come wash, relax, and meet cool people.</p>
